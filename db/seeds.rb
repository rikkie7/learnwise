...
course7 = Course.create!(title: "Business", description: "Business 101", category: "education", size: "group", price: 300, image_url: "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", user: user14, start_date: "2024-12-01", end_date: "2025-08-01", location: "22 Howard Street, Perth", format: "in_person")
puts "#{Course.last.title} created!"
...
Booking.create!(user: user10, course: Course.find_by(title: "Yoga"))
Booking.create!(user: user11, course: Course.find_by(title: "Cooking"))
Booking.create!(user: user12, course: Course.find_by(title: "Football"))
Booking.create!(user: user13, course: Course.find_by(title: "Football"))
Booking.create!(user: user14, course: Course.find_by(title: "Yoga"))
Booking.create!(user: user15, course: Course.find_by(title: "Yoga"))
Booking.create!(user: user16, course: Course.find_by(title: "Cooking"))
Booking.create!(user: user7, course: Course.find_by(title: "Cooking"))
Booking.create!(user: user2, course: Course.find_by(title: "Business"))
Booking.create!(user: user3, course: Course.find_by(title: "Business"))
Booking.create!(user: user4, course: Course.find_by(title: "Business"))
