...
course4 = Course.create!(title: "Cooking 101: Kitchen Basics to Advanced", description: "Learn to cook with me - I love to teach cooking to my students - so many techniques and recipes! See you in the kitchen!", category: "cooking", size: "group", price: 150, image_url: "https://images.unsplash.com/photo-1556910103-1c02745aae4d?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", user: user4, start_date: "2024-08-01", end_date: "2024-12-01", location: "395 Pitt Street, Sydney, New South Wales 2000", format: "in_person")
puts "#{Course.last.title} created!"
...
course7 = Course.create!(title: "An Entire MBA in 1 Course:Award Winning Business School Prof", description: "B** #1 Best Selling Business Course! ** Everything You Need to Know About Business from Start-up to IPO", category: "education", size: "group", price: 300, image_url: "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", user: user14, start_date: "2024-12-01", end_date: "2025-08-01", location: "29 Cameron Street, Launceston, Tasmania 7250", format: "in_person")
puts "#{Course.last.title} created!"

course8 = Course.create!(title: "First Aid Masterclass: A Complete Guide to First Aid", description: "The Complete Guide to First Aid and Emergency Medicine: Learn CPR, Heimlich, How to Stop Bleedings, Baby Care & More!", category: "others", size: "group", price: 200, image_url: "https://plus.unsplash.com/premium_photo-1663050906605-faa2aa0e5ff8?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", user: user6, start_date: "2024-08-10", end_date: "2024-08-10", location: "8 Franklin Street, Melbourne, Victoria 3000", format: "in_person")
puts "#{Course.last.title} created!"
...
Booking.create!(user: user11, course: Course.find_by(title: "Cooking 101: Kitchen Basics to Advanced"))
...
Booking.create!(user: user16, course: Course.find_by(title: "Cooking 101: Kitchen Basics to Advanced"))
Booking.create!(user: user7, course: Course.find_by(title: "Cooking 101: Kitchen Basics to Advanced"))
