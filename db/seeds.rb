...
course3 = Course.create!(title: "Chair Yoga Teacher Training Certificate - Yoga Alliance CE", description: "Learn Safe and Effective Seated Yoga - 30 HR Yoga Alliance CE Approved", category: "sports", format: "in_person", size: "private", price: 50, image_url: "https://images.unsplash.com/photo-1506126613408-eca07ce68773?q=80&w=2202&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", user: user2, start_date: "2024-08-01 18:00:00", end_date: "2024-12-01 21:00:00 ", location: "51-53 Mort Street, Braddon, Australian Capital Territory 2601", latitude: -35.271214, longitude: 149.131370)
puts "#{Course.last.title} created!"

course4 = Course.create!(title: "Cooking 101: From Basics to Advanced Techniques for Mastering Every Dish", description: "Learn to cook with me - I love to teach cooking to my students - so many techniques and recipes! ", category: "cooking", size: "group", price: 150, image_url: "https://images.unsplash.com/photo-1556910103-1c02745aae4d?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", user: user4, start_date: "2024-09-01 18:00:00", end_date: "2024-12-01 21:00:00", location: "395 Pitt Street, Sydney, New South Wales 2000", format: "in_person", latitude: -33.877068, longitude: 151.207145)
puts "#{Course.last.title} created!"
...
course6 = Course.create!(title: "The Ultimate Soccer Guide | Play Like A Pro Soccer Player", description: "Learn how to drastically improve your soccer skills, fitness, confidence, and game intelligence FASTER than ever before.", category: "sports", size: "group", price: 10, image_url: "https://plus.unsplash.com/premium_photo-1661856745445-14fd848f0e53?q=80&w=2858&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", user: user7, start_date: "2024-10-01 18:00:00", end_date: "2025-02-01 18:00:00", location: "2-4 Market Place, Hobart, Tasmania 7000", format: "in_person", latitude: -42.881062, longitude: 147.331543)
puts "#{Course.last.title} created!"
