...
course3 = Course.create!(title: "Chair Yoga Teacher Training Certificate - Yoga Alliance CE", description: "Learn Safe and Effective Seated Yoga - 30 HR Yoga Alliance CE Approved", category: "sports", format: "in_person", size: "private", price: 50, image_url: "https://images.unsplash.com/photo-1506126613408-eca07ce68773?q=80&w=2202&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", user: user2, start_date: "2025-11-01", end_date: "2025-12-01", location: "51-53 Mort Street, Braddon, Australian Capital Territory 2601", latitude: -35.271214, longitude: 149.131370)
puts "#{Course.last.title} created!"

course4 = Course.create!(title: "Cooking 101: From Basics to Advanced Techniques for Mastering Every Dish", description: "Learn to cook with me - I love to teach cooking to my students - so many techniques and recipes! ", category: "cooking", size: "group", capacity: 50, price: 150, image_url: "https://images.unsplash.com/photo-1556910103-1c02745aae4d?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", user: user4, start_date: "2025-09-05", end_date: "2025-12-01", location: "395 Pitt Street, Sydney, New South Wales 2000", format: "in_person", latitude: -33.877068, longitude: 151.207145)
puts "#{Course.last.title} created!"

course5 = Course.create!(title: "Beginners Guide to Organic Vegetable Gardening Techniques", description: "Gardening guidelines for establishing a nutrient rich and delectable culinary garden in your own backyard.", category: "gardening", size: "group", capacity: 50, price: 50, image_url: "https://images.unsplash.com/photo-1621460248083-6271cc4437a8?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", user: user5, start_date: "2025-01-01", end_date: "2025-03-01", location: "814 Pittwater Road, Dee Why, New South Wales 2099", format: "in_person", latitude: -33.758530, longitude: 151.281560)
puts "#{Course.last.title} created!"

course6 = Course.create!(title: "The Ultimate Soccer Guide | Play Like A Pro Soccer Player", description: "Learn how to drastically improve your soccer skills, fitness, confidence, and game intelligence FASTER than ever before.", category: "sports", size: "group", capacity: 50, price: 10, image_url: "https://plus.unsplash.com/premium_photo-1661856745445-14fd848f0e53?q=80&w=2858&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", user: user7, start_date: "2025-10-01", end_date: "2025-12-01", location: "2-4 Market Place, Hobart, Tasmania 7000", format: "in_person", latitude: -42.881062, longitude: 147.331543)
puts "#{Course.last.title} created!"

course7 = Course.create!(title: "An Entire MBA in 1 Course:Award Winning Business School Prof", description: "#1 Best Selling Business Course! Everything You Need to Know About Business from Start-up to IPO", category: "education", size: "group", capacity: 50, price: 300, image_url: "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", user: user14, start_date: "2025-12-01", end_date: "2026-08-01", location: "29 Cameron Street, Launceston, Tasmania 7250", format: "in_person", latitude: -41.434720, longitude: 147.140950)
puts "#{Course.last.title} created!"

course8 = Course.create!(title: "First Aid Masterclass: A Complete Guide to First Aid", description: "The Complete Guide to First Aid and Emergency Medicine: Learn CPR, Heimlich, How to Stop Bleedings, Baby Care & More!", category: "others", size: "group", capacity: 50, price: 200, image_url: "https://plus.unsplash.com/premium_photo-1663050906605-faa2aa0e5ff8?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", user: user6, start_date: "2025-08-31", end_date: "2026-09-10", location: "8 Franklin Street, Melbourne, Victoria 3000", format: "in_person", latitude: -37.807430, longitude: 144.961980)
puts "#{Course.last.title} created!"

course9 = Course.create!(title: "Rust: The Complete Developer's Guide", description: "Become a Rust engineer. Understand ownership, lifetimes, traits, generics, and much more through practical projects", category: "technology", format: "online", size: "group", capacity: 50, price: 100, image_url: "https://miro.medium.com/v2/resize:fit:1400/format:webp/0*ywP7NFzW-8ZWilwJ.png", user: user1, start_date: "2025-10-01", end_date: "2025-12-01")
...
Message.create!(content: "How can I grow plants indoors?", user: user, chatroom: chatroom3, created_at: "2024-08-25 18:56:00")
Message.create!(content: "To grow plants indoors, ensure they have sufficient light, either from a sunny window or grow lights. Choose suitable plants like herbs, succulents, or houseplants, and maintain proper humidity and watering.", user: user5, chatroom: chatroom3, created_at: "2024-08-25 21:04:45")
Message.create!(content: "How do I get rid of weeds naturally?", user: user14, chatroom: chatroom3, created_at: "2024-08-26 13:14:08")
Message.create!(content: "Natural weed control methods include mulching, hand-pulling, using vinegar or boiling water, and ensuring proper garden spacing to reduce weed growth.", user: user5, chatroom: chatroom3, created_at: "2024-08-26 14:04:45")
Message.create!(content: "What plants are best for beginners?", user: user, chatroom: chatroom3, created_at: "2024-08-27 18:00:00")
Message.create!(content: "Some beginner-friendly plants include herbs (like basil and mint), tomatoes, marigolds, sunflowers, and succulents. These plants are generally low-maintenance and forgiving.", user: user5, chatroom: chatroom3, created_at: "2024-08-27 21:04:45")
Message.create!(content: "How often do I need to water my plants?", user: user14, chatroom: chatroom3, created_at: "2024-08-28 12:34:05")
Message.create!(content: "The frequency of watering depends on the plant type, climate, and soil. Generally, it’s best to water deeply but less frequently to encourage deep root growth. Check the soil moisture before watering to avoid overwatering.", user: user10, chatroom: chatroom3, created_at: "2024-08-28 15:05:56")
Message.create!(content: "How can I prevent pests in my garden?", user: user14, chatroom: chatroom3, created_at: "2024-08-28 18:34:08")
Message.create!(content: "To prevent pests, use natural deterrents like neem oil, garlic spray, or diatomaceous earth. Introducing beneficial insects like ladybugs or practicing companion planting can also help keep pests at bay.", user: user15, chatroom: chatroom3, created_at: "2024-08-28 18:56:45")
Message.create!(content: "How do I improve my soil quality?", user: user, chatroom: chatroom3, created_at: "2024-08-29 20:04:54")
Message.create!(content: "Soil quality can be improved by adding organic matter like compost, manure, or mulch. Regularly testing your soil and adjusting pH levels as needed can also help.", user: user10, chatroom: chatroom3, created_at: "2024-08-29 20:20:26")
