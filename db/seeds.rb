...
course4 = Course.create!(title: "Cooking 101: From Basics to Advanced Techniques for Mastering Every Dish", description: "Learn to cook with me - I love to teach cooking to my students - so many techniques and recipes! ", category: "cooking", size: "group", capacity: 50, price: 150, image_url: "https://images.unsplash.com/photo-1556910103-1c02745aae4d?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", user: user4, start_date: "2024-09-05", end_date: "2024-12-01", location: "395 Pitt Street, Sydney, New South Wales 2000", format: "in_person", latitude: -33.877068, longitude: 151.207145)
puts "#{Course.last.title} created!"
