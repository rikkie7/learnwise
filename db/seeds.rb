...
course1 = Course.create!(title: "The Complete Ruby on Rails Developer Professional Training Course", description: "Learn to make innovative web apps with Ruby on Rails and unleash your creativity", category: "technology", format: "online", size: "group", price: 100, image_url: "https://community.theforeman.org/uploads/default/optimized/2X/8/83d09280c8809460222474ef8f7dbc94ee39abc9_2_690x362.png", user: user3, start_date: "2024-09-01", end_date: "2025-12-01")
...
course4 = Course.create!(title: "Cooking 101: From Basics to Advanced Techniques for Mastering Every Dish", description: "Learn to cook with me - I love to teach cooking to my students - so many techniques and recipes! ", category: "cooking", size: "group", price: 150, image_url: "https://images.unsplash.com/photo-1556910103-1c02745aae4d?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", user: user4, start_date: "2024-09-01", end_date: "2024-12-01", location: "395 Pitt Street, Sydney, New South Wales 2000", format: "in_person", latitude: -33.877068, longitude: 151.207145)
puts "#{Course.last.title} created!"
...
course7 = Course.create!(title: "An Entire MBA in 1 Course:Award Winning Business School Prof", description: "#1 Best Selling Business Course! Everything You Need to Know About Business from Start-up to IPO", category: "education", size: "group", price: 300, image_url: "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", user: user14, start_date: "2024-12-01", end_date: "2025-08-01", location: "29 Cameron Street, Launceston, Tasmania 7250", format: "in_person", latitude: -41.434720, longitude: 147.140950)
puts "#{Course.last.title} created!"

course8 = Course.create!(title: "First Aid Masterclass: A Complete Guide to First Aid", description: "The Complete Guide to First Aid and Emergency Medicine: Learn CPR, Heimlich, How to Stop Bleedings, Baby Care & More!", category: "others", size: "group", price: 200, image_url: "https://plus.unsplash.com/premium_photo-1663050906605-faa2aa0e5ff8?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", user: user6, start_date: "2024-08-31", end_date: "2024-09-10", location: "8 Franklin Street, Melbourne, Victoria 3000", format: "in_person", latitude: -37.807430, longitude: 144.961980)
puts "#{Course.last.title} created!"

course9 = Course.create!(title: "Rust: The Complete Developer's Guide", description: "Become a Rust engineer. Understand ownership, lifetimes, traits, generics, and much more through practical projects", category: "technology", format: "online", size: "group", price: 100, image_url: "https://miro.medium.com/v2/resize:fit:1400/format:webp/0*ywP7NFzW-8ZWilwJ.png", user: user1, start_date: "2024-10-01", end_date: "2024-12-01")
puts "#{Course.last.title} created!"
